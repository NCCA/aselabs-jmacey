...
NGLScene::NGLScene(int _numParticles, QWidget *_parent) : m_numParticles{_numParticles}, QOpenGLWidget(_parent)
{
...
void NGLScene::initializeGL()
{
  ...
  m_emitter=std::make_unique<Emitter>(ngl::Vec3(0.0f,0.0f,0.0f),m_numParticles,1.5f,m_numParticles*2,200);
...
void NGLScene::addParticles(int _numParticles)
{
	m_emitter->addParticles(_numParticles);
	update();
}
